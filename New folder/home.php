          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                ...
                <p>Our platform is designed for collaborative learning, enhanced by gamification elements, and accessible anytime, anywhere through responsive design. Stay ahead in the digital era.</p>
              </div>
          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                ...
                <p>Step into a world of vibrant education with our engaging toons background on our online learning website.</p>
              </div>
              <div class="fea-img pull-left">
          ...
          <div class="fea">
            <div class="col-md-4">
              <div class="heading pull-right">
                ...
                <p>Immerse yourself in an award-winning design as you explore our online learning website Join us on a platform where innovation meets design, and education is not just informative but visually inspiring</p>
              </div>
              <div class="fea-img pull-left">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-info">
            ...
            <p class="det-p">The affordability of inclusive, quality education remains a critical global challenge. While strides have been made to enhance accessibility, financial barriers persist, particularly in regions with limited resources.</p>
          </div>
        </div> 
    ...
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          ...
          <p>With a commitment to excellence in teaching, research, and mentorship, our faculty members create an inspiring and dynamic learning environment.</p>
          <hr class="bottom-line">
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            ...
            <div class="pm-staff-profile-details text-center">
              <p class="pm-staff-profile-name">Johnson</p>
              <p class="pm-staff-profile-title">Lead Software Engineer</p>

              <p class="pm-staff-profile-bio">Our distinguished faculty members are the heartbeat of our institution, bringing a wealth of knowledge, experience, and passion to the forefront of our academic community. </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            ...
            <div class="pm-staff-profile-details text-center">
              <p class="pm-staff-profile-name">Rishi</p>
              <p class="pm-staff-profile-title">Lead Software Engineer</p>

              <p class="pm-staff-profile-bio">Meet our exceptional faculty, a team of dedicated experts committed to shaping the minds of tomorrow. With a wealth of experience in their fields, they bring real-world insights to the classroom. </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div class="pm-staff-profile-container">
            ...
            <div class="pm-staff-profile-details text-center">
              <p class="pm-staff-profile-name">Pranay</p>
              <p class="pm-staff-profile-title">Lead Software Engineer</p>

              <p class="pm-staff-profile-bio"> Our accomplished faculty member are the backbone of our academic community, offering a wealth of expertise and dedication. With diverse backgrounds and a commitment to excellence environment of dynamic learning </p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="text-comment">
            <p class="text-par">"I can confidently say it has been a game-changer in my educational journey"</p>
            <p class="text-name">Abhiram - Creative Director</p>
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
          <div class="text-comment">
            <p class="text-par">"Grateful to be part of a community that truly values and prioritizes quality learning"</p>
            <p class="text-name">Akshay - Creative Director</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="img/course1.jpg" class="img-responsive">
           
            <figcaption>
              <h3>HTML tutorial</h3>
              <p> Designed for beginners and aspiring developers Dive into the essentials of Hypertext Markup Language (HTML), mastering the art of structuring content for web.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="img/course2.jpg" class="img-responsive">
            
            <figcaption>
              <h3>Java tutorial</h3>
              <p>Master the principles of object-oriented programming and delve into Java's versatile applications in software development Through practical exercises.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="img/course3.jpg" class="img-responsive">
           
            <figcaption>
              <h3>CSS tutorial</h3>
              <p> Discover the power of Cascading Style Sheets (CSS) to enhance the look and feel of your websites from layout design to color schemes and responsive elements.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="img/course4.jpg" class="img-responsive">
           
            <figcaption>
              <h3>php tutorial</h3>
              <p>Dive into the dynamic world of PHP, mastering its syntax and its powerful features for web development, developers seeking to expand their web programming capabilities.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            ...
            <figcaption>
              <h3>MY SQL tutorial</h3>
              <p>From designing relational databases to executing complex queries and ensuring data integrity Acquire practical skills in handling large datasets and performance through real-world projects.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up">
            <img src="img/course6.jpg" class="img-responsive">
            
            <figcaption>
              <h3>BOOTSTRAP tutorial</h3>
              <p>Bootstrap course, designed for both novice and experienced developers. Uncover the power of this front-end framework, mastering responsive design and creating mobile-friendly websites effortlessly.</p>
            </figcaption>
            <a href="#"></a>
          </figure>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            ...
            <div class="pricing-head">
              <h4>Monthly Plan in ₹</h4>
              <span class="₹"></span> <span class="amount">200</span>
            </div>
        ...
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            <!-- Plan  -->
            <div class="pricing-head">
              <h4>Quarterly Plan in ₹</h4>
              <span class="₹"></span> <span class="amount">800</span>
            </div>
        ...
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            ...
            <div class="pricing-head">
              <h4>Year Plan in ₹</h4>
              <span class="₹"></span> <span class="amount">1200</span>
            </div>
